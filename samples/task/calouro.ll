...
; ModuleID = 'calouro.cpp'
source_filename = "calouro.cpp"
...
; ModuleID = '/tmp/calouro-5656ba.bc'
source_filename = "calouro.cpp"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"
...
@.str.2 = private unnamed_addr constant [23 x i8] c"Primeiro valor de A=%d\00", align 1
@.str.4 = private unnamed_addr constant [22 x i8] c"Secundo valor de A=%d\00", align 1
...
omp_if.then:                                      ; preds = %entry
  ...
  %21 = call i8* @__kmpc_omp_task_alloc(%ident_t* @0, i32 %2, i32 1, i64 56, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates.1*)* @.omp_task_entry..5 to i32 (i32, i8*)*), i32 0, i32 0)
...
entry:
  ...
  %call.i = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i32 0, i32 0), i32 %12)
...
lpad.i:                                           ; preds = %entry
  ...
  call void @__clang_call_terminate(i8* %exn.i) #7
  unreachable
...
; Function Attrs: noinline uwtable
define internal i32 @.omp_task_entry..5(i32, %struct.kmp_task_t_with_privates.1* noalias) #4 personality i32 (...)* @__gxx_personality_v0 {
entry:
  %.global_tid..addr.i = alloca i32, align 4
  %.part_id..addr.i = alloca i32*, align 8
  %.privates..addr.i = alloca i8*, align 8
  ...
  %ref.i = load i32*, i32** %11, align 8
  %12 = load i32, i32* %ref.i, align 4
  %call.i = invoke i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4, i32 0, i32 0), i32 %12)
          to label %.omp_outlined..3.exit unwind label %lpad.i
...
.omp_outlined..3.exit:                            ; preds = %entry
  %16 = getelementptr inbounds %struct.anon.0, %struct.anon.0* %10, i32 0, i32 0
  %ref1.i = load i32*, i32** %16, align 8
  store i32 3, i32* %ref1.i, align 4
  ret i32 0
}
