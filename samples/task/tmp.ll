...
@__omp_offloading_806_1223bed_main_l12_property = weak constant %struct.__openmp_nvptx_target_property_ty { i8 1, i32 0, i32 0 }, align 1
@__omp_offloading_806_1223bed_main_l16_property = weak constant %struct.__openmp_nvptx_target_property_ty.0 { i8 1, i32 0, i32 0 }, align 1
...
define weak void @__omp_offloading_806_1223bed_main_l12(i32* dereferenceable(4) %A, i8* %scratchpad_ptr) #1 {
entry:
  ...
  %2 = icmp eq i32 %1, 1
  br i1 %2, label %.master.i, label %__omp_offloading_806_1223bed_main_l12_impl__.exit
...
for.end6.i:                                       ; preds = %for.cond.i
  ...
  br label %__omp_offloading_806_1223bed_main_l12_impl__.exit

__omp_offloading_806_1223bed_main_l12_impl__.exit: ; preds = %entry, %for.end6.i
  ret void
}
...
; Function Attrs: noinline nounwind
define weak void @__omp_offloading_806_1223bed_main_l16(i32* dereferenceable(4) %A, i8* %scratchpad_ptr) #1 {
entry:
  %A.addr.i = alloca i32*, align 8
  %A.addr = alloca i32*, align 8
  %scratchpad_ptr.addr = alloca i8*, align 8
  ...
  %2 = icmp eq i32 %1, 1
  br i1 %2, label %.master.i, label %__omp_offloading_806_1223bed_main_l16_impl__.exit
...
.master.i:                                        ; preds = %entry
  ...
  call void @__kmpc_kernel_deinit(i16 0) #3
  call void @llvm.nvvm.barrier0() #3
  br label %__omp_offloading_806_1223bed_main_l16_impl__.exit

__omp_offloading_806_1223bed_main_l16_impl__.exit: ; preds = %entry, %.master.i
  ret void
}
...
.await.work.i:                                    ; preds = %.barrier.parallel.i, %.worker
  ...
  br i1 %should_terminate.i, label %__omp_offloading_806_1223bed_main_l12_worker.exit, label %.select.workers.i
...
__omp_offloading_806_1223bed_main_l12_worker.exit: ; preds = %.await.work.i
  br label %.exit

.exit:                                            ; preds = %__omp_offloading_806_1223bed_main_l12_worker.exit, %entry
...
.await.work.i:                                    ; preds = %.barrier.parallel.i, %.worker
  ...
  %7 = load volatile i8*, i8** %work_fn.i, align 8
  %should_terminate.i = icmp eq i8* %7, null
  br i1 %should_terminate.i, label %__omp_offloading_806_1223bed_main_l16_worker.exit, label %.select.workers.i
...
__omp_offloading_806_1223bed_main_l16_worker.exit: ; preds = %.await.work.i
  br label %.exit

.exit:                                            ; preds = %__omp_offloading_806_1223bed_main_l16_worker.exit, %entry
  %9 = load i32, i32* %retval, align 4
  ret i32 %9
}
...
!0 = !{i32 0, i32 2054, i32 19020781, !"main", i32 16, i32 1}
!1 = !{i32 0, i32 2054, i32 19020781, !"main", i32 12, i32 0}
!2 = !{void (i32*, i8*)* @__omp_offloading_806_1223bed_main_l12, !"kernel", i32 1}
!3 = !{void (i32*, i8*)* @__omp_offloading_806_1223bed_main_l16, !"kernel", i32 1}
!4 = !{null, !"align", i32 8}
...
@.omp_offloading.entry_name = internal unnamed_addr constant [38 x i8] c"__omp_offloading_806_1223bed_main_l12\00"
@.omp_offloading.entry_module = internal unnamed_addr constant [1 x i8] zeroinitializer
@.omp_offloading.entry.__omp_offloading_806_1223bed_main_l12 = weak constant %struct.__tgt_offload_entry { i8* bitcast (void (i32*)* @__omp_offloading_806_1223bed_main_l12 to i8*), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.omp_offloading.entry_name, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.omp_offloading.entry_module, i32 0, i32 0), i64 0, i32 0, i32 0, i32 0 }, section ".omp_offloading.entries", align 1
@.omp_offloading.entry_name.1 = internal unnamed_addr constant [38 x i8] c"__omp_offloading_806_1223bed_main_l16\00"
@.omp_offloading.entry_module.2 = internal unnamed_addr constant [1 x i8] zeroinitializer
@.omp_offloading.entry.__omp_offloading_806_1223bed_main_l16 = weak constant %struct.__tgt_offload_entry { i8* bitcast (void (i32*)* @__omp_offloading_806_1223bed_main_l16 to i8*), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.omp_offloading.entry_name.1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.omp_offloading.entry_module.2, i32 0, i32 0), i64 0, i32 0, i32 0, i32 0 }, section ".omp_offloading.entries", align 1

; Function Attrs: noinline nounwind uwtable
define weak void @__omp_offloading_806_1223bed_main_l12(i32* dereferenceable(4) %A) #0 {
entry:
  %A.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind uwtable
define weak void @__omp_offloading_806_1223bed_main_l16(i32* dereferenceable(4) %A) #0 {
entry:
  %A.addr = alloca i32*, align 8
  store i32* %A, i32** %A.addr, align 8
  %0 = load i32*, i32** %A.addr, align 8
...
@__omp_offloading_806_1223bed_main_l12.region_id = weak constant i8 0
...
@__omp_offloading_806_1223bed_main_l16.region_id = weak constant i8 0
...
@.omp_offloading.entry_name = internal unnamed_addr constant [38 x i8] c"__omp_offloading_806_1223bed_main_l12\00"
@.omp_offloading.entry_module = internal unnamed_addr constant [1 x i8] zeroinitializer
@.omp_offloading.entry.__omp_offloading_806_1223bed_main_l12 = weak constant %struct.__tgt_offload_entry { i8* @__omp_offloading_806_1223bed_main_l12.region_id, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.omp_offloading.entry_name, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.omp_offloading.entry_module, i32 0, i32 0), i64 0, i32 0, i32 0, i32 0 }, section ".omp_offloading.entries", align 1
@.omp_offloading.entry_name.10 = internal unnamed_addr constant [38 x i8] c"__omp_offloading_806_1223bed_main_l16\00"
@.omp_offloading.entry_module.11 = internal unnamed_addr constant [1 x i8] zeroinitializer
@.omp_offloading.entry.__omp_offloading_806_1223bed_main_l16 = weak constant %struct.__tgt_offload_entry { i8* @__omp_offloading_806_1223bed_main_l16.region_id, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.omp_offloading.entry_name.10, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.omp_offloading.entry_module.11, i32 0, i32 0), i64 0, i32 0, i32 0, i32 0 }, section ".omp_offloading.entries", align 1
...
omp_if.then:                                      ; preds = %entry
  ...
  %12 = call i8* @__kmpc_omp_target_task_alloc(%ident_t* @0, i32 %2, i32 1, i64 80, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*), i64 1)
  ...
  %43 = call i8* @__kmpc_omp_target_task_alloc(%ident_t* @0, i32 %2, i32 1, i64 80, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates.1*)* @.omp_task_entry..8 to i32 (i32, i8*)*), i64 0)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %58, i8* bitcast ([1 x i64]* @.offload_sizes.3 to i8*), i64 8, i32 8, i1 false)
...
; Function Attrs: noinline nounwind uwtable
define internal void @__omp_offloading_806_1223bed_main_l12(i32* dereferenceable(4) %A) #2 {
entry:
  %A.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %25 = call i32 @__tgt_target_nowait(i64 1, i8* @__omp_offloading_806_1223bed_main_l12.region_id, i32 1, i8** %22, i8** %23, i64* %24, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @.offload_maptypes.2, i32 0, i32 0), i8* %14) #6
  %26 = icmp ne i32 %25, 0
  br i1 %26, label %omp_offload.failed.i, label %.omp_outlined..1.exit

omp_offload.failed.i:                             ; preds = %entry
  call void @__omp_offloading_806_1223bed_main_l12(i32* %ref.i) #6
...
; Function Attrs: noinline nounwind uwtable
define internal void @__omp_offloading_806_1223bed_main_l16(i32* dereferenceable(4) %A) #2 {
entry:
  %A.addr = alloca i32*, align 8
  store i32* %A, i32** %A.addr, align 8
  %0 = load i32*, i32** %A.addr, align 8
...
; Function Attrs: alwaysinline uwtable
define internal void @.omp_task_privates_map..7(%struct..kmp_privates.t.2* noalias, [1 x i8*]** noalias, [1 x i8*]** noalias, [1 x i64]** noalias) #3 {
entry:
...
; Function Attrs: noinline uwtable
define internal i32 @.omp_task_entry..8(i32, %struct.kmp_task_t_with_privates.1* noalias) #4 {
entry:
  %.global_tid..addr.i = alloca i32, align 4
  %.part_id..addr.i = alloca i32*, align 8
  %.privates..addr.i = alloca i8*, align 8
  ...
  %23 = getelementptr inbounds [1 x i8*], [1 x i8*]* %20, i64 0, i64 0
  %24 = getelementptr inbounds [1 x i64], [1 x i64]* %21, i64 0, i64 0
  %25 = call i32 @__tgt_target_nowait(i64 0, i8* @__omp_offloading_806_1223bed_main_l16.region_id, i32 1, i8** %22, i8** %23, i64* %24, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @.offload_maptypes.6, i32 0, i32 0), i8* %14) #6
  %26 = icmp ne i32 %25, 0
  br i1 %26, label %omp_offload.failed.i, label %.omp_outlined..5.exit

omp_offload.failed.i:                             ; preds = %entry
  call void @__omp_offloading_806_1223bed_main_l16(i32* %ref.i) #6
